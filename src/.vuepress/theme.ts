...
export default hopeTheme({
  hostname: "https://svvkcn.cn/my-docs/",//"https://svvkcn.github.io/my-docs/",//"https://mister-hope.github.io",

  author: {
    name: "svvk.cn",
    url: "https://www.svvk.cn",//"https://mister-hope.com",
  },
  ...
  // https://github.com/svvkcn/my-docs
  repo: "/svvkcn/my-docs",
  ...
  blog: {
    medias: {
      BiliBili: "https://space.bilibili.com/480794295",
      ...
      SvvkCn: ["https://www.svvk.cn", MR_HOPE_AVATAR],
    },
  },
  ...
  locales: {
    ...
    "/en/": {
      ...
      blog: {
        description: "good good learn, day day up",
        intro: "/en/intro.html",
      },
